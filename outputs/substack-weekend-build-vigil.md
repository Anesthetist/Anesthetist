...
I didn't study yoga. I was thinking about kinesiology — the mechanics of the body, not the philosophy. But people in class kept saying things like, "Everything you have, want, or need is already inside of you." And I thought: *What? That doesn't make any sense to me.* And then I got curious about why it didn't make sense. I couldn't see the problem. I couldn't see the solution. Because it was operating at an energy level just below where I was looking.

So I started reading. BKS Iyengar — *Light on Yoga*, *Light on Life*, *Light on Pranayama*. And then a bunch more, Eastern and Western — human performance optimization, physiology-based, science-based. What the Eastern traditions brought out was that there's no word in English for "chi" or "pranayama." No equivalent concept. And the shadow that the *lack* of that concept causes is enormous — the same way "self-compassion" didn't exist in my vocabulary until maybe three years ago. A word that seems obvious once you learn it. A clinical tool hiding in plain sight: how clinicians can use self-forgiveness, how to manage the inner voice, how to work with emotions as they arise in real time instead of stuffing them until they erode you from inside.
